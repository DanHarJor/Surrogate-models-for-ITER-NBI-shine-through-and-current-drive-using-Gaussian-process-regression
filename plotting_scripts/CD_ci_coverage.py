"""CI-coverage diagnostics for the best current-drive (CD) active-learning
surrogate (selected by CD_active_learning_comparison.py, persisted in
plotting_scripts/best_model_dir_CD/).
...
def restore_noise_normalization(gpy):
    """See CD_make_best_model_plots.py: recompute the noise GP's target
