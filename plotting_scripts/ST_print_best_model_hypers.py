"""Print GPy kernel hyperparameters for the best shine-through (ST)
active-learning surrogate (selected by ST_active_learning_comparison.py,
persisted in plotting_scripts/best_model_dir_ST/).
